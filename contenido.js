// EDITE SOLAMENTE LOS TEXTOS ENTRE COMILLAS INVERTIDAS (`).
// Puede escribir textos largos y usar varios renglones.
...
Como era en el principio, ahora y siempre, por los siglos de los siglos. Amén. `,
  days: [
    { texto: `Día 1 Novena de la Virgen Desatanudos
...
Jesús es el gran desatador de nuestros pecados (nudos); pero también la Virgen María es la que le dio su carne y su sangre para que hecho hombre pudiera salvarnos del pecado y de la muerte. Dios se valió de una mujer para salvarnos; también se quiere valer de nosotros, como instrumentos para que su Hijo Jesús nos siga salvando.`, texto2: `Oración a Nuestra Señora la que desata los nudos:
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 1
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 2
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 3
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 4
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 5
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 6
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 7
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 8
...
En el nombre del Padre, del Hijo y del Espíritu Santo.` }, // Día 9

  ]
};

// Mientras un día conserve la palabra "texto" o "texto2", mostrará
// automáticamente el contenido completo del Día 1.
// Para personalizarlo, sustituya solamente ese campo en el día deseado.
NOVENA_CONTENT.days.forEach((day, index) => {
  if (index === 0) return;
  if (day.texto.trim() === 'texto') day.texto = NOVENA_CONTENT.days[0].texto;
  if (day.texto2.trim() === 'texto2') day.texto2 = NOVENA_CONTENT.days[0].texto2;
});
